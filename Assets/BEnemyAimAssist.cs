...
public class BEnemyAimAssist : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bow = GetComponentInParent<BEnemyBow>();
    }
    ...
    void Update()
    {
        ...
        float remainingDistance = scanDistances[Mathf.Min(3, bow.chargeLevel)];

        Vector3 lastHitPoint = transform.position;
        lastHitPoint.z = 0;
        Vector3 reflectAngle = bow.transform.right;
        reflectAngle.z = 0;
